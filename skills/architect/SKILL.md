---
name: architect
description: "Sketch types, signatures, and module structure before code, then stay in the loop while implementation fills in. Load via the skill tool for architect this, design this, or non-trivial work where jumping to code would lock in the wrong shape."
...
Use multiple independent architect runners on the inherited parent model. Omit `Task.model` from every runner call.
