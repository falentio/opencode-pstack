...
description: "Generate a project-local verification skill that drives your app the way a user does. Any language, framework, or platform. Load via the skill tool to make a control skill for this repo, or when a project has no scripted way to prove UI/CLI/service behavior."
