...
The [Opening a PR playbook](../../skills/poteto-mode/playbooks/opening-a-pr.md) loads the [deslop skill](../../skills/deslop/SKILL.md) on the diff before each commit and applies the [unslop skill](../../skills/unslop/SKILL.md) to the PR description and commit bodies. Deslop ships in this package. It removes narrating comments, unsupported guards, dead compatibility paths, and unrelated edits.
